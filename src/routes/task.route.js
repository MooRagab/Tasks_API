...
router.get("/tasksbycategory", auth(), filterTasksByCategory); //filter tasks by category
router.get("/tasksbyprivacy", auth(), filterTasksByPrivacy); //filter tasks by privacy
